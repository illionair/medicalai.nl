...
Cohesion: 0.31
Nodes (9): defaultCover(), leakyPipeCover(), rocCurveCover(), scaleBalanceCover(), getCover(), escapeXml(), paletteFor(), svgToDataUri() (+1 more)

### Community 8 - "Community 8"
Cohesion: 0.24
Nodes (9): cleanMarkdown(), escapeXml(), extractSummary(), makeCoverImage(), paletteFor(), parseFrontmatter(), readArticle(), staticArticleMatchesTopic() (+1 more)
