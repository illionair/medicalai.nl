...
## Corpus Check
- 97 files · ~187,081 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 278 nodes · 389 edges · 13 communities detected
...
Cohesion: 0.26
Nodes (14): Home(), TopicPage(), HubPage(), getBlogById(), getBlogsForTopic(), getCategoryCounts(), getPublishedBlogs(), getPublishedBlogsByCategory() (+6 more)
...
Cohesion: 0.21
Nodes (8): cleanMarkdown(), escapeXml(), extractSummary(), isStaticArticleId(), makeCoverImage(), paletteFor(), readArticle(), wrapWords()

### Community 7 - "Community 7"
Cohesion: 0.19
Nodes (6): AucPlayground(), formatDecimal(), formatNumber(), ratio(), rocPath(), thresholdStats()

### Community 9 - "Community 9"
Cohesion: 0.44
Nodes (6): assertEnv(), getAdminEmails(), getRequiredEnv(), isAdminEmail(), normalizeSiteUrl(), resolveSiteUrl()
...
- **Why does `getStaticArticleById()` connect `Community 3` to `Community 0`, `Community 6`?**
